    ...
    children: [
      ...
      { label: "Company News / Blog", path: "/resources/blog" },
      {
        ...
        children: build("/resources/help-center/using-musicosy", [
          ...
          ["Backstage & Community", ["What is Backstage?", "Send a message", "Manage message requests", "Start a group conversation", "Share content in Backstage", "Mute a conversation", "Join a community or fan club", "Subscribe to a creator"]],
