...
export const helpCenterSections: NavNode[] = [
    ...
    children: [
      ...
      { label: "Company News / Blog", path: "/resources/blog" },
      {
        ...
        children: build("/resources/help-center/using-musicosy", [
          ...
          ["Creator Studio & Workspaces", ["Set up your creator profile", "Set up your creator profile and Artist Page", "Create or join a workspace", "Switch workspaces", "Workspace roles and permissions", "Invite and manage workspace members", "Collaborate in Studio", "View creator analytics", "Manage your catalog", "Credits, rights, and splits", "Distribution", "Creator tools and eligibility", "Verification on MusicOSY", "Build an EPK (Electronic Press Kit)"]],
        ]),
      },
    ],
  },
  ...
  // ── 2. SUPPORT CENTER ────────────────────────────────────────────────────
  {
    ...
    children: build("/support", [
      ["Account & Access", ["Account settings & privacy", "Account privacy and visibility settings", "Notification settings", "Push notifications", "Account status", "Account safety", "Manage your active sessions", "Set up two-factor authentication or a passkey", "Sign-in help", "Recover your account", "Reset your password", "Verify your identity", "Deactivate your account", "Delete your account"]],
