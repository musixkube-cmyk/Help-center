...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Tabs" description="Manage and configure tabs." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Notifications", href: "/ads/src/app/ads/account/notifications" }, { label: "Tabs" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
