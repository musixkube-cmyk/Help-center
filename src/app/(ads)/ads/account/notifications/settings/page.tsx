...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Settings" description="Manage and configure settings." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Notifications", href: "/ads/src/app/ads/account/notifications" }, { label: "Settings" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
