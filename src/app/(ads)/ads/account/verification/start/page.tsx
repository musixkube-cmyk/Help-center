...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Start" description="Manage and configure start." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Verification", href: "/ads/src/app/ads/account/verification" }, { label: "Start" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
