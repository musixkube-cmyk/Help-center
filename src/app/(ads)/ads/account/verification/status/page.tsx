...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Status" description="Manage and configure status." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Verification", href: "/ads/src/app/ads/account/verification" }, { label: "Status" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
