...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Invite" description="Manage and configure invite." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Team", href: "/ads/src/app/ads/account/team" }, { label: "Invite" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
