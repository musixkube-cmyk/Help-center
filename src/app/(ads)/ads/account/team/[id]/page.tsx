...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Details" description="Manage and configure details." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Team", href: "/ads/src/app/ads/account/team" }, { label: "Details" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
