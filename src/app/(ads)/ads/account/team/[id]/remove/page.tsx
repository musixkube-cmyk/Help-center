...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Remove" description="Manage and configure remove." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Account", href: "/ads/src/app/ads/account" }, { label: "Team", href: "/ads/src/app/ads/account/team" }, { label: "Details", href: "/ads/src/app/ads/account/team/[id]" }, { label: "Remove" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
