...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Details" description="Manage and configure details." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Catalog", href: "/ads/src/app/ads/catalog" }, { label: "Products", href: "/ads/src/app/ads/catalog/products" }, { label: "Details" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
