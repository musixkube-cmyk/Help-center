...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Brand Safety" description="Manage and configure brand safety." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Settings", href: "/ads/src/app/ads/settings" }, { label: "Brand Safety" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
