...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Location" description="Manage and configure location." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Audiences", href: "/ads/src/app/ads/audiences" }, { label: "Location" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
