...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Edit" description="Manage and configure edit." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Audiences", href: "/ads/src/app/ads/audiences" }, { label: "Details", href: "/ads/src/app/ads/audiences/[id]" }, { label: "Edit" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
