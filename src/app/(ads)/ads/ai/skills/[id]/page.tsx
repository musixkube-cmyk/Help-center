...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Details" description="Manage and configure details." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Ai", href: "/ads/src/app/ads/ai" }, { label: "Skills", href: "/ads/src/app/ads/ai/skills" }, { label: "Details" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
