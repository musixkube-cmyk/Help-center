...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Cpa" description="Manage and configure cpa." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Analytics", href: "/ads/src/app/ads/analytics" }, { label: "Cpa" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
