...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Comments" description="Manage and configure comments." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Analytics", href: "/ads/src/app/ads/analytics" }, { label: "Comments" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
