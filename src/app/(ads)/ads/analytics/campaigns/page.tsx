...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Campaigns" description="Manage and configure campaigns." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Analytics", href: "/ads/src/app/ads/analytics" }, { label: "Campaigns" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
