...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Genre" description="Manage and configure genre." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Analytics", href: "/ads/src/app/ads/analytics" }, { label: "Audience", href: "/ads/src/app/ads/analytics/audience" }, { label: "Genre" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
