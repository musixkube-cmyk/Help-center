...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Action Request" description="Manage and configure action request." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Campaigns", href: "/ads/src/app/ads/campaigns" }, { label: "Action Request" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
