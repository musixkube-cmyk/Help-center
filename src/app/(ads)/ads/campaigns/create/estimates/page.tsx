...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Estimates" description="Manage and configure estimates." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Campaigns", href: "/ads/src/app/ads/campaigns" }, { label: "Create", href: "/ads/src/app/ads/campaigns/create" }, { label: "Estimates" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
