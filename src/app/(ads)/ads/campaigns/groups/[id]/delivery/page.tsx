...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Delivery" description="Manage and configure delivery." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Campaigns", href: "/ads/src/app/ads/campaigns" }, { label: "Groups", href: "/ads/src/app/ads/campaigns/groups" }, { label: "Details", href: "/ads/src/app/ads/campaigns/groups/[id]" }, { label: "Delivery" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
