...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Edit" description="Manage and configure edit." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Campaigns", href: "/ads/src/app/ads/campaigns" }, { label: "Groups", href: "/ads/src/app/ads/campaigns/groups" }, { label: "Details", href: "/ads/src/app/ads/campaigns/groups/[id]" }, { label: "Edit" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
