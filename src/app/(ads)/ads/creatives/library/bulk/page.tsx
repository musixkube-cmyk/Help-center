...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Bulk" description="Manage and configure bulk." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Creatives", href: "/ads/src/app/ads/creatives" }, { label: "Library", href: "/ads/src/app/ads/creatives/library" }, { label: "Bulk" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
