...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Tags" description="Manage and configure tags." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Creatives", href: "/ads/src/app/ads/creatives" }, { label: "Library", href: "/ads/src/app/ads/creatives/library" }, { label: "Tags" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
