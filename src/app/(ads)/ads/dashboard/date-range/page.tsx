...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Date Range" description="Manage and configure date range." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Dashboard", href: "/ads/src/app/ads/dashboard" }, { label: "Date Range" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
