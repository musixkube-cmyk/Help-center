...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Actions" description="Manage and configure actions." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Dashboard", href: "/ads/src/app/ads/dashboard" }, { label: "Actions" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
