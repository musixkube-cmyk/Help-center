...
export default function Page() {
  ...
  return (
    <div>
      <PageHeader title="Add" description="Manage and configure add." breadcrumbs={[{ label: "Ad Center", href: "/ads" }, { label: "Src", href: "/ads/src" }, { label: "App", href: "/ads/src/app" }, { label: "Ads", href: "/ads/src/app/ads" }, { label: "Agency", href: "/ads/src/app/ads/agency" }, { label: "Clients", href: "/ads/src/app/ads/agency/clients" }, { label: "Add" }]} actions={<Link href="/ads"><Button variant="secondary">Create</Button></Link>} />
